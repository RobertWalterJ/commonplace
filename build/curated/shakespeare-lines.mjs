...
export const LINES = [
  ...
  { f: 'what dreams may come', work: 'hamlet',
    why: 'The reason Hamlet does not act: not death, but the dreaming that might follow it. Three separate phrases came into English out of this one sentence — a “rub” was a flaw in a bowling green that threw the bowl off line, and “coil” means turmoil, so the mortal coil is a mess you get out of rather than anything serpentine.',
  ...
  { f: 'something wicked this way comes', work: 'macbeth',
    why: 'The second witch, feeling Macbeth approach — she can tell what he has become by the way he registers. The pricking thumb is a folk superstition: an itch that warns of danger.',
